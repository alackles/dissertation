...
\setlength{\cftbeforetoctitleskip}{-0.3in}
\setlength{\cftaftertoctitleskip}{0.375in}
...
\setlength{\cftbeforelottitleskip}{-0.3in}
\setlength{\cftafterlottitleskip}{0.375in}
\renewcommand{\cftlottitlefont}{\Large\bfseries}
\renewcommand{\listtablename}{\begin{center}\large{LIST OF TABLES}\end{center}}

\setlength{\cftbeforeloftitleskip}{-0.3in}
\setlength{\cftafterloftitleskip}{0.365in}
